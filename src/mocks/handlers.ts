...
export const handlers = [
	...
	http.get( '/api/transactions', () => {
		return HttpResponse.json([
			...
			{ source: 'transfer', amount: -856, date: '2025-01-04', description: 'Payment to Allan Rickman', category: 'other' },
			{ source: 'transfer', amount: -533, date: '2025-01-04', description: 'Payment to Jemi Wilson', category: 'other' },
			{ source: 'card', amount: -48, date: '2025-01-04', description: 'Movie tickets payment', category: 'entertainment' },
			{ source: 'paypal', amount: 2354, date: '2025-01-05', description: 'Deposit from PayPal', category: 'income' },
			{ source: 'card', amount: -663, date: '2025-01-05', description: 'Groceries', category: 'other' },
			{ source: 'transfer', amount: -972, date: '2025-01-06', description: 'Dinner', category: 'entertainment' },
			{ source: 'transfer', amount: -533, date: '2025-01-06', description: 'Payment to Jemi Wilson', category: 'other' },
			{ source: 'card', amount: -48, date: '2025-01-06', description: 'Movie tickets payment', category: 'entertainment' },
			{ source: 'paypal', amount: 2354, date: '2025-01-07', description: 'Deposit from PayPal', category: 'income' },
			{ source: 'card', amount: -663, date: '2025-01-07', description: 'Groceries', category: 'other' },
			{ source: 'transfer', amount: -972, date: '2025-01-07', description: 'Dinner', category: 'entertainment' },
			{ source: 'bank', amount: -134, date: '2025-01-08', description: 'Water Service', category: 'bill' },
			{ source: 'bank', amount: -253, date: '2025-01-08', description: 'Light Service', category: 'bill' },
			{ source: 'bank', amount: -261, date: '2025-01-08', description: 'Internet Service', category: 'bill' },
			{ source: 'transfer', amount: 3492, date: '2025-01-09', description: 'Salary', category: 'income' },
			{ source: 'card', amount: -1243, date: '2025-01-09', description: 'Hotel', category: 'other' },
			{ source: 'paypal', amount: -987, date: '2025-01-09', description: 'Amazon', category: 'other' },
			{ source: 'bank', amount: 765, date: '2025-01-10', description: 'Investments', category: 'investment' },
			{ source: 'card', amount: -72, date: '2025-01-10', description: 'Apple One', category: 'bill' },
			{ source: 'transfer', amount: 2873, date: '2025-01-10', description: 'Payment from Daniel Craig', category: 'income' },
			{ source: 'paypal', amount: -654, date: '2025-01-10', description: 'Amazon', category: 'other' },
		])
	}),
